                ...
                <nav class="navbar navbar-expand-md navbar-dark bg-success">
                    ...
                    <div class="collapse navbar-collapse" id="Navbar">
                        <ul class="navbar-nav text-md-center nav-justified w-100">
                            ...
                            <li class="nav-item"><a class="nav-link" href="${path_from_file_to_root}content/talk/">対談</a></li>
                            <li class="nav-item"><a class="nav-link" href="${path_from_file_to_root}content/question/">質問コーナー</a></li>
                            <li class="nav-item"><a class="nav-link" href="${path_from_file_to_root}content/quiz/">クイズ</a></li>
                            <li class="nav-item"><a class="nav-link" href="${path_from_file_to_root}content/information/">資料室</a></li>
                        </ul>
                    </div>
                </nav>
            </div>
